  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SingleChildScrollView(
        child: SafeArea(
          child: Form(
            key: pickupController.pickupForm1,
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: TextFormField(
                    onChanged: (val) {
                      pickupController.name.value = val;
                    },
                    onSaved: (val) {
                      pickupController.name.value = val.toString();
                    },
                ...
                Container(
                  ...
                  child: TextFormField(
                    onChanged: (val) {
                      pickupController.phone.value = val;
                    },
                    onSaved: (val) {
                      pickupController.phone.value = val.toString();
                    },
                    decoration: InputDecoration(
                ...
                Container(
                  ...
                  child: TextFormField(
                    onChanged: (val) {
                      pickupController.address1.value = val + ' ';
                    },
                    onSaved: (val) {
                      pickupController.address1.value = val.toString() + ' ';
                    },
                    decoration: InputDecoration(
                  ...
                  children: [
                    Flexible(
                      child: Container(
                        ...
                        child: TextFormField(
                          onChanged: (val) {
                            pickupController.pincode.value = val;
                          },
                          onSaved: (val) {
                            pickupController.pincode.value = val.toString();
                          },
                          decoration: InputDecoration(
                            labelText: 'Zip Code',
                            hintText: 'Eg. 221007',
                    ...
                    Flexible(
                      child: Container(
                        ...
                        child: TextFormField(
                          onChanged: (val) {
                            pickupController.city.value = val;
                          },
                          onSaved: (val) {
                            pickupController.city.value = val.toString();
                          },
                          decoration: InputDecoration(
                            labelText: 'City',
                            hintText: 'Eg. Delhi',
                ...
                Container(
                  ...
                  child: TextFormField(
                    onChanged: (val) {
                      pickupController.state.value = val;
                    },
                    onSaved: (val) {
                      pickupController.state.value = val.toString();
                    },
                    decoration: InputDecoration(
                      labelText: 'State',
